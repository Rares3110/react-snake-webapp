...
const TermsPage: React.FC = () => {
    ...
    return (
        <>
            <NavBar />
            <main className="w-full max-w-[1200px] bg-opacity-30 bg-black mt-12 text-white">
                <article>
                ...
                <article>
                    ...
                    <p className="px-4 mt-4 text-md sm:text-lg">We store the email, username and password for authentication, if the user decides to create an account.
                        When the user is authenticated, every score will be saved in the database to update the <a onClick={() => navigate('/leaderboards')} className="italic">leaderboards</a>.
