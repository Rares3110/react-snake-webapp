...
const LoginInfoSmall: React.FC = observer(() => {
    ...
    return (<div>
        {userData.id === undefined ? <motion.button className="h-14 flex items-center w-[144px] bg-blue-500 rounded-2xl shadow-button mt-4 justify-center"
...
const FullSizeSnakePage: React.FC = () => {
    ...
    >
        ...
        {showSideInfo && <div className="absolute top-4 right-3 flex flex-col items-center font-bold text-5xl text-white">
            <div>Score</div>
