        ...
        <>
            {
                userData.id === undefined ?
                    <p className="flex items-center justify-around text-blue-500 bg-black bg-opacity-50 text-xl max-w-[400px] mt-4 mb-[-20px] rounded-2xl">
...
const HomePage: React.FC = () => {
    ...
    return (<>
        ...
        <header className="relative w-full h-80 mt-14">
            <div className="flex w-full h-full">
                <img className="w-1/3 object-cover object-top" src={Pic1Header} alt="gameplay image" />
                <img className="w-1/3 object-cover" src={Pic2Header} alt="gameplay image" />
                <img className="w-1/3 object-cover" src={Pic3Header} alt="gameplay image" />
            </div>
            ...
            <h1 className="absolute top-10 w-full text-7xl text-center text-white font-bold">
                SuperSnake
            </h1>
        </header>

        <main className="flex flex-col items-center">
            <aside className="flex items-center justify-around text-blue-500 bg-black bg-opacity-50 text-xl max-w-[410px] my-8 rounded-2xl">
                <img src={BuildImage} alt="" className="h-20 w-20 mr-3 ml-2" />
                <span>At the moment, any user will need a <span className="text-gold">keyboard</span> to play SuperSnake! Gestures are not yet available but will be in the near future.</span>
            </aside>
            ...
            <section className="flex flex-col items-center">
                <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="flex items-center w-[380px] h-16 rounded-full bg-rose-700 select-none shadow-button"
                    onClick={() => {
                        navigate('/game');
                        window.scrollTo(0, 0);
                    }}
                ...
                <span className="mt-2 text-4xl font-bold text-white">Score {score}</span>
                ...
                <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="mt-14 flex items-center w-[380px] h-16 rounded-full bg-green-600 select-none shadow-button"
                    onClick={() => {
            ...
            <section>
                <article className="flex flex-col items-center">
                    ...
                    <div className="flex flex-col items-center sm:flex-row sm:items-start justify-between mt-10 gap-10 w-[90%] sm:w-[607px]">
                        ...
                        <p className="text-white text-2xl w-full sm:w-auto">
                ...
                <article className="flex flex-col items-center">
                    <h2 className="text-white font-semibold text-4xl border-b-4 pb-1 border-white mt-10">Controls</h2>
                    ...
                    <div className="flex flex-col items-center sm:flex-row sm:items-start justify-between mt-10 w-[90%] sm:w-[500px]">
                        ...
                        <p className="text-white text-2xl w-[320px] mt-2 sm:mt-0 sm:w-auto">
                    ...
                    <div className="w-full flex justify-center mb-52">
                        <p className="text-white text-2xl w-[340px] sm:w-[490px] mt-5 text-justify">
