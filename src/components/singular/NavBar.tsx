...
const NavBar: React.FC = observer(() => {
    ...
    return (<div className="fixed z-[200] top-0 w-full h-14 bg-darker-space-cadet shadow-navbar-darker-space-cadet">
        <div className="absolute right-4 flex flex-row-reverse items-center h-full text-2xl font-semibold text-white bottom-[2px]">
            <motion.button
